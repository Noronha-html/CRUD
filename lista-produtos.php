...
<main>
  ...
  <div class="container">
      ...
      <a href="./salvar-produtos.php?acao=salvar&id=" class="btn btn-add">Incluir</a> 
      <table>
        <thead>
          <tr>
            <th>ID</th>
        ...
        <tbody>
          ...
          while($row = mysqli_fetch_assoc($result)) {
            echo "<tr>
                    ...
                    <td>" . $row['Preco'] . "</td>
                    <td>
                        <a href='salvar-produtos.php?id=" . $row['ProdutoID'] . "&acao=salvar' class='btn btn-edit'>Editar</a>
